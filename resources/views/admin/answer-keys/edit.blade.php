...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                <form action="{{ route('admin.answer-keys.update', $answerKey->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" id="title" class="form-control" 
                                               value="{{ old('title', $answerKey->title) }}" required maxlength="255">
                                        @error('title')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="job_id" id="job_id" class="form-control" required>
                                            ...
                                            @foreach($jobs as $job)
                                                <option value="{{ $job->id }}" {{ old('job_id', $answerKey->job_id) == $job->id ? 'selected' : '' }}>
                                                    {{ $job->title }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="short_description" id="short_description" class="form-control" 
                                          maxlength="500" rows="2">{{ old('short_description', $answerKey->short_description) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description" class="form-control" rows="4">{{ old('description', $answerKey->description) }}</textarea>
                                @error('description')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="answer_key_date" id="answer_key_date" 
                                               class="form-control" value="{{ old('answer_key_date', $answerKey->answer_key_date->format('Y-m-d')) }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="exam_name" id="exam_name" class="form-control" 
                                               value="{{ old('exam_name', $answerKey->exam_name) }}" maxlength="255">
                                        @error('exam_name')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="exam_date" id="exam_date" 
                                               class="form-control" value="{{ old('exam_date', $answerKey->exam_date ? $answerKey->exam_date->format('Y-m-d') : '') }}">
                                        @error('exam_date')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="total_questions" id="total_questions" 
                                               class="form-control" value="{{ old('total_questions', $answerKey->total_questions) }}" min="1">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="total_marks" id="total_marks" 
                                               class="form-control" value="{{ old('total_marks', $answerKey->total_marks) }}" min="1">
                                        @error('total_marks')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="correct_marks" id="correct_marks" 
                                               class="form-control" value="{{ old('correct_marks', $answerKey->correct_marks ?? 1.00) }}" min="0">
                                        @error('correct_marks')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="negative_marks" id="negative_marks" 
                                               class="form-control" value="{{ old('negative_marks', $answerKey->negative_marks ?? 0.25) }}" min="0">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="url" name="official_website" id="official_website" 
                                               class="form-control" value="{{ old('official_website', $answerKey->official_website) }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="url" name="download_link" id="download_link" 
                                               class="form-control" value="{{ old('download_link', $answerKey->download_link) }}" required>
                                        @error('download_link')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="url" name="answer_key_url" id="answer_key_url" 
                                               class="form-control" value="{{ old('answer_key_url', $answerKey->answer_key_url) }}" placeholder="https://example.com/answer-key-login">
                                        <small class="text-muted">Direct link to candidate answer key login/portal</small>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="url" name="objection_link" id="objection_link" 
                                               class="form-control" value="{{ old('objection_link', $answerKey->objection_link) }}" placeholder="https://example.com/raise-objection">
                            ...
                            <div class="form-group">
                                ...
                                @if($answerKey->answer_key_file)
                                    <div class="mb-2">
                                        ...
                                        Current file: 
                                        <a href="{{ route('admin.answer-keys.download', $answerKey->id) }}" target="_blank">
                                            {{ basename($answerKey->answer_key_file) }}
                                        </a>
                                        <br>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <textarea name="instructions" id="instructions" class="form-control" rows="3">{{ old('instructions', $answerKey->instructions) }}</textarea>
                                @error('instructions')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div id="subjects-container">
                                    @php
                                        $subjects = old('subjects', $answerKey->subjects ?? []);
                                    @endphp
                                    @if(count($subjects) > 0)
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="meta_title" id="meta_title" class="form-control" 
                                               value="{{ old('meta_title', $answerKey->meta_title) }}" maxlength="255">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="meta_keywords" id="meta_keywords" class="form-control" 
                                               value="{{ old('meta_keywords', $answerKey->meta_keywords) }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="meta_description" id="meta_description" class="form-control" rows="3">{{ old('meta_description', $answerKey->meta_description) }}</textarea>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="is_active" value="1" {{ old('is_active', $answerKey->is_active) ? 'checked' : '' }}>
