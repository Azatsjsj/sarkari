...
<head>
    ...
    <!-- Robots & Crawling -->
    <meta name="googlebot" content="{{ $__env->yieldContent('meta_googlebot', $metaRobots) }}">
    <meta name="bingbot" content="{{ $__env->yieldContent('meta_bingbot', $metaRobots) }}">
    ...
    <meta name="language" content="@yield('meta_language', 'en')">
    <meta name="country" content="India">

    <!-- Author & Publisher -->
    <meta name="publisher" content="Sarkari Result Mobi">
    <meta name="copyright" content="Sarkari Result {{ date('Y') }}">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark sticky-top shadow-lg" aria-label="Main navigation">
        <div class="container">
            <!-- Logo -->
            <a class="navbar-brand" href="{{ route('home') }}" aria-label="Sarkari Result Home">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admit-cards*') ? 'active' : '' }}"
                           href="{{ route('admit-cards') }}">
                            <i class="fas fa-ticket-alt me-1" aria-hidden="true"></i> Admit Cards
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('answer-keys*') && !request()->routeIs('answer-key-calculator') ? 'active' : '' }}"
                           href="{{ route('answer-keys') }}">
                            <i class="fas fa-key me-1" aria-hidden="true"></i> Answer Keys
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('answer-key-calculator') ? 'active' : '' }}"
                           href="{{ route('answer-key-calculator') }}">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-lg" aria-label="Job categories">
                            ...
                            @forelse($categories as $category)
                                <li>
                                    <a class="dropdown-item py-2" href="{{ route('categories.show', $category->slug) }}">
                                        <i class="fas fa-folder me-2 text-primary" aria-hidden="true"></i>
                                        {{ $category->name }}
                                        @if($category->jobs_count > 0)
                                            <span class="badge bg-primary rounded-pill ms-2">{{ number_format($category->jobs_count) }}</span>
                                        @endif
                                    </a>
                                </li>
                            @empty
                            ...
                            @if($categories && $categories->count() > 0)
                                ...
                                <li>
                                    <a class="dropdown-item text-primary fw-semibold py-2" href="{{ route('jobs') }}">
                ...
                <!-- Search Form -->
                <form action="{{ route('jobs') }}" method="GET" class="search-form me-3 my-2 my-lg-0" role="search" aria-label="Site search">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-lg py-0" style="width: 320px; max-width: 90vw;">
                            ...
                            <div style="max-height: 300px; overflow-y: auto;">
                                ...
                                <li>
                                    <a class="dropdown-item py-2 px-3 text-wrap border-bottom {{ !$n->is_read ? 'bg-light font-weight-bold' : '' }}" href="{{ $n->link ?: '#' }}">
                                        <div class="d-flex align-items-start">
                                            <i class="fas {{ $n->icon ?: 'fa-bell text-primary' }} me-2 mt-1"></i>
                                            <div>
                                                <div class="small fw-bold text-dark mb-0">{{ Str::limit($n->title, 45) }}</div>
                                                <small class="text-muted" style="font-size: 11px;">{{ $n->created_at->diffForHumans() }}</small>
                                            </div>
                                        </div>
                                    </a>
                                </li>
                            ...
                            <li class="dropdown-footer text-center bg-light py-2 border-top">
                                <a href="{{ route('notifications.index') }}" class="text-dark small font-weight-bold">See All Live Updates &rarr;</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                    ...
                    @auth
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end shadow-lg">
                                <li><a class="dropdown-item py-2" href="{{ route('admin.dashboard') }}"><i class="fas fa-tachometer-alt me-2 text-primary" aria-hidden="true"></i>Dashboard</a></li>
                                <li><a class="dropdown-item py-2" href="{{ route('admin.jobs.index') }}"><i class="fas fa-briefcase me-2 text-success" aria-hidden="true"></i>Manage Jobs</a></li>
                                <li><a class="dropdown-item py-2" href="{{ route('admin.results.index') }}"><i class="fas fa-chart-bar me-2 text-info" aria-hidden="true"></i>Manage Results</a></li>
                                <li><a class="dropdown-item py-2" href="{{ route('admin.admit-cards.index') }}"><i class="fas fa-ticket-alt me-2 text-warning" aria-hidden="true"></i>Manage Admit Cards</a></li>
                                <li><hr class="dropdown-divider my-1"></li>
                                <li>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-2 col-md-6">
                    ...
                    <ul class="list-unstyled d-flex flex-column gap-2">
                        <li><a href="{{ route('home') }}"><i class="fas fa-chevron-right me-2" aria-hidden="true"></i>Home</a></li>
                        <li><a href="{{ route('jobs') }}"><i class="fas fa-chevron-right me-2" aria-hidden="true"></i>Latest Sarkari Jobs</a></li>
                        <li><a href="{{ route('results') }}"><i class="fas fa-chevron-right me-2" aria-hidden="true"></i>Check All Results</a></li>
                        <li><a href="{{ route('admit-cards') }}"><i class="fas fa-chevron-right me-2" aria-hidden="true"></i>Download Admit Card</a></li>
                        <li><a href="{{ route('answer-keys') }}"><i class="fas fa-chevron-right me-2" aria-hidden="true"></i>Answer Keys</a></li>
                        <li><a href="{{ route('documents.index') }}"><i class="fas fa-chevron-right me-2" aria-hidden="true"></i>Notices</a></li>
                    </ul>
                </div>
                            ...
                            @foreach($categories->take(5) as $category)
                                <li>
                                    <a href="{{ route('categories.show', $category->slug) }}">
                                        <i class="fas fa-chevron-right me-2" aria-hidden="true"></i>{{ $category->name }}
                                    </a>
                                </li>
                            @endforeach
                        @else
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <p class="mb-0 text-secondary small">
                        &copy; {{ date('Y') }} SarkariResult.mobi. All rights reserved.
                    </p>
                </div>
                <div class="col-md-6 text-md-end">
                    <div class="d-flex gap-4 justify-content-md-end">
                        <a href="{{ route('privacy-policy') }}" class="text-secondary small">Privacy Policy</a>
                        <a href="{{ route('terms-of-service') }}" class="text-secondary small">Terms of Service</a>
                        <a href="{{ route('disclaimer') }}" class="text-secondary small">Disclaimer</a>
                    </div>
                </div>
            </div>
        </div>
