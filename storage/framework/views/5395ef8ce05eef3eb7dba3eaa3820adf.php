 <style>
        /* refined custom styles - no keyword stuffing, professional */
            ...
            <div class="col-lg-7">
                <div class="card h-100 border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="mt-3"><a href="#" class="btn-primary-custom"><i class="fas fa-search"></i> Explore latest vacancies</a></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-5">
...
</div><?php /**PATH E:\SARKARIMOBI\sarkariresult.mobi\resources\views/components/maincantent.blade.php ENDPATH**/ ?>