...
<?php $__env->startSection('title', mb_substr($pageDisplayTitle ?? $answerKey->title, 0, 53) . ' - Sarkari Result 2026'); ?>
<?php $__env->startSection('meta_description', trim((string) ($pageDisplayDescription ?? ($answerKey->short_description ?: ($answerKey->description ?: 'Download answer key for ' . $answerKey->title))))); ?>
...
<div class="sarkari-container">
    ...
    <div class="sarkari-breadcrumb">
        ...
        <a href="<?php echo e(route('answer-keys')); ?>">Answer Keys</a> &gt;
        <?php if($answerKey->job && $answerKey->job->category): ?>
        <a href="<?php echo e(route('category', $answerKey->job->category->slug)); ?>"><?php echo e($answerKey->job->category->name); ?></a> &gt;
        <?php endif; ?>
        <span><?php echo e(Str::limit($pageDisplayTitle ?? ($answerKey->title ?: ($answerKey->slug ? Str::of($answerKey->slug)->replace(['_', '-'], ' ')->replaceMatches('/\s+/', ' ')->squish()->title()->toString() : 'Answer Key Details')), 40)); ?></span>
    </div>
        ...
        <div class="col-left">
            ...
            <div class="post-header">
                <div class="post-title">
                    <h1>
                        ...
                        <?php echo e($pageDisplayTitle ?? ($answerKey->title ?: ($answerKey->slug ? Str::of($answerKey->slug)->replace(['_', '-'], ' ')->replaceMatches('/\s+/', ' ')->squish()->title()->toString() : 'Answer Key Details'))); ?>
                ...
                <div class="post-meta">
                    <table class="info-table">
                        <tr>
                            ...
                            <td><strong><?php echo e($answerKey->title); ?></strong></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                <?php if($updateDate): ?>
                                    <?php echo e(safe_date_format($updateDate, 'd M Y')); ?> | <?php echo e(safe_date_format($updateDate, 'h:i A')); ?>
                        ...
                        <tr>
                            <td>Exam Name:</td>
                            <td><?php echo e($answerKey->exam_name); ?></td>
                        </tr>
                        <?php endif; ?>
                        <?php if($answerKey->job): ?>
                        <tr>
                            <td>Organization:</td>
                            <td><?php echo e($answerKey->job->category->name ?? 'N/A'); ?></td>
                        </tr>
                        <?php endif; ?>
                        <tr>
                            ...
                            <td>
                                <strong>
                                    <?php echo e(safe_date_format($answerKeyDate, 'd M Y')); ?>
            ...
            <div class="section-box">
                ...
                <div class="section-content">
                    ...
                    <p><?php echo e($answerKey->short_description); ?></p>
                    <?php endif; ?>
                    
                    <?php if($answerKey->description): ?>
                    <div style="margin-top: 15px;">
                        <?php echo nl2br(e($answerKey->description)); ?>

                    </div>
                    <?php endif; ?>
                    
                    <?php if($answerKey->instructions): ?>
                    <div style="margin-top: 15px;">
                        <strong><i class="fas fa-list-ol"></i> Instructions:</strong>
                        <div style="margin-top: 10px;">
                            <?php echo nl2br(e($answerKey->instructions)); ?>
                ...
                <div class="section-content p-3" style="background: #fffdfa;">
                    ...
                    <div style="display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 15px;">
                        <div style="flex: 1; min-width: 140px;">
                            ...
                            <input type="number" id="calcTotalQuestions" class="form-control" value="<?php echo e($answerKey->total_questions ?? 100); ?>" min="1" oninput="window.calculateAnswerKeyScore()" style="width: 100%; padding: 6px 10px; border-radius: 4px; border: 1px solid #ccc;">
                        </div>
                        <div style="flex: 1; min-width: 140px;">
                        ...
                        <div style="flex: 1; min-width: 120px;">
                            ...
                            <input type="number" step="0.25" id="calcMarksPerRight" class="form-control" value="<?php echo e($answerKey->correct_marks ?? 1.00); ?>" min="0" oninput="window.calculateAnswerKeyScore()" style="width: 100%; padding: 6px 10px; border-radius: 4px; border: 1px solid #ccc;">
                        </div>
                        <div style="flex: 1; min-width: 140px;">
                            ...
                            <select id="calcNegativePenalty" class="form-select" onchange="window.calculateAnswerKeyScore()" style="width: 100%; padding: 6px 10px; border-radius: 4px; border: 1px solid #ccc;">
                                <option value="0.25" <?php echo e(($answerKey->negative_marks ?? 0.25) == 0.25 ? 'selected' : ''); ?>>0.25 (1/4th)</option>
                                <option value="0.33" <?php echo e(($answerKey->negative_marks ?? 0.25) == 0.33 ? 'selected' : ''); ?>>0.33 (1/3rd)</option>
                                <option value="0.50" <?php echo e(($answerKey->negative_marks ?? 0.25) == 0.50 ? 'selected' : ''); ?>>0.50 (1/2)</option>
                                <option value="1.00" <?php echo e(($answerKey->negative_marks ?? 0.25) == 1.00 ? 'selected' : ''); ?>>1.00 (1 Mark)</option>
                                <option value="0.00" <?php echo e(($answerKey->negative_marks ?? 0.25) == 0.00 ? 'selected' : ''); ?>>0.00 (No Negative)</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                        ...
                        <?php if($answerKey->answer_key_url || $answerKey->download_link): ?>
                        <a href="<?php echo e($answerKey->answer_key_url ?: $answerKey->download_link); ?>" target="_blank" style="flex: 1; min-width: 180px; background: #28a745; color: #fff; font-weight: bold; padding: 10px; border-radius: 5px; text-decoration: none; text-align: center; display: inline-block;">
                ...
                <div class="section-content">
                    <table class="info-table" style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($downloadLink): ?>
                                <a href="<?php echo e($downloadLink); ?>" target="_blank" style="color: #28a745; font-weight: bold;">
                        ...
                        <?php if($answerKey->objection_link || $answerKey->official_website): ?>
                        <tr>
                            <td>Submit Online Objection:</td>
                            <td>
                                <a href="<?php echo e($answerKey->objection_link ?: $answerKey->official_website); ?>" target="_blank" rel="nofollow, noopener" style="color: #dc3545; font-weight: bold;">
                        ...
                        <?php if($answerKey->job && $answerKey->job->notification_pdf): ?>
                        <tr>
                            <td>Download Notification:</td>
                            <td>
                                <a href="<?php echo e(Storage::url($answerKey->job->notification_pdf)); ?>" target="_blank" style="color: #28a745; font-weight: bold;">
                                    Click Here
                                </a>
                            </td>
                        </tr>
                        ...
                        <?php if($answerKey->official_website): ?>
                        <tr>
                            <td>Official Website:</td>
                            <td>
                                <a href="<?php echo e($answerKey->official_website); ?>" target="_blank" rel="nofollow, noopener, noreferrer" style="color: #28a745; font-weight: bold;">
                                    Click Here
                                </a>
                            </td>
                        </tr>
        ...
        <div class="col-right">
            ...
            <div class="section-box">
                ...
                <div class="section-content">
                    ...
                    ?>
                    <?php if($downloadButtonLink): ?>
                    <a href="<?php echo e($downloadButtonLink); ?>" target="_blank" class="download-btn" style="background: linear-gradient(135deg, #28a745 0%, #1e7e34 100%); color: #fff; display: block; text-align: center; padding: 12px; border-radius: 5px; text-decoration: none; font-weight: bold; margin-bottom: 10px;">
                        <i class="fas fa-key"></i> Open Official Answer Key URL
                    </a>
                    <?php endif; ?>

                    <?php if($answerKey->objection_link): ?>
                    <a href="<?php echo e($answerKey->objection_link); ?>" target="_blank" class="official-btn" style="background: linear-gradient(135deg, #fd7e14 0%, #d9480f 100%); color: #fff; display: block; text-align: center; padding: 12px; border-radius: 5px; text-decoration: none; font-weight: bold; margin-bottom: 10px;">
                        <i class="fas fa-edit"></i> Raise Objections Online
                    </a>
                    <?php elseif(!$downloadButtonLink): ?>
                    ...
                    <?php if($answerKey->job && $answerKey->job->notification_pdf): ?>
                    <a href="<?php echo e(Storage::url($answerKey->job->notification_pdf)); ?>" target="_blank" class="official-btn" style="background: #17a2b8; margin-top: 10px;">
                    ...
                    <ul class="date-list">
                        <li>
                            ...
                            <span class="date-value">
                                <?php if(isset($answerKey->is_active) && $answerKey->is_active): ?>
                        ...
                        <li>
                            ...
                            <span class="date-value">
                                ...
                                ?>
                                <?php if($createdAt): ?>
                                    <?php echo e($createdAt->format('d M Y')); ?>
                        ...
                        <li>
                            ...
                            <span class="date-value"><?php echo e(number_format($answerKey->download_count ?? 0)); ?></span>
                        </li>
                        <li>
                            <span class="date-label">Views:</span>
                            <span class="date-value"><?php echo e(number_format($answerKey->views ?? 0)); ?></span>
                        </li>
                        <?php if(isset($answerKey->file_size) && $answerKey->file_size): ?>
                        <li>
                            <span class="date-label">File Size:</span>
                            <span class="date-value"><?php echo e($answerKey->file_size); ?></span>
                        </li>
                        <?php endif; ?>
                        <?php if(isset($answerKey->total_questions) && $answerKey->total_questions): ?>
                        <li>
                            <span class="date-label">Total Questions:</span>
                            <span class="date-value"><?php echo e($answerKey->total_questions); ?></span>
                        </li>
                        <?php endif; ?>
                    </ul>
                </div>
            ...
            <!-- Related Answer Keys -->
            <?php if(isset($relatedAnswerKeys) && $relatedAnswerKeys->count() > 0): ?>
            <div class="section-box">
                ...
                <div class="section-content">
                    <div class="related-grid">
                        <?php $__currentLoopData = $relatedAnswerKeys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="related-item">
                            <div class="related-title">
                                <a href="<?php echo e(route('answer-key.show', $related->slug ?? $related->id)); ?>">
                            ...
                            <div class="related-date">
                                ...
                                ?>
                                <?php if($relatedDate): ?>
                                    <?php echo e($relatedDate->format('d M Y')); ?>
            ...
            <div class="section-box">
                ...
                <div class="section-content">
                    <div class="share-buttons">
                        ...
                        <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(url()->current())); ?>&text=<?php echo e(urlencode($answerKey->title)); ?>" 
                           target="_blank" rel="nofollow, noopener, noreferrer" class="share-btn twitter">
                            <i class="fab fa-twitter"></i> Twitter
                        </a>
                        <a href="https://wa.me/?text=<?php echo e(urlencode($answerKey->title . ' - ' . url()->current())); ?>" 
                           target="_blank" rel="nofollow, noopener, noreferrer" class="share-btn whatsapp">
                            <i class="fab fa-whatsapp"></i> WhatsApp
                        </a>
                        <a href="https://t.me/share/url?url=<?php echo e(urlencode(url()->current())); ?>&text=<?php echo e(urlencode($answerKey->title)); ?>" 
...
function trackDownload() {
    console.log('Download initiated for: ' + <?php echo json_encode($answerKey->title, 15, 512) ?>);
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\SARKARIMOBI\sarkariresult.mobi\resources\views/answer-keys/show.blade.php ENDPATH**/ ?>